...
class User extends AppModel {
    ...
    public $hasOne = array(
        ...
        'Teamleader' => array(
            ...
            'foreignKey' => 'id',
            'dependent' => true,
            'conditions' => 'User.role="TeamLeader"',
            'fields' => '',
            'order' => '',
            'limit' => '',
            'offset' => '',
    ...
    public function afterSave($created , $options = array())
    {
        if($created)
        {
            $user_role = $this->data[$this->alias]['role'];
            $user_id = $this->id;
            switch ($user_role) {
                case 'SuperAdmin':
                    $superadmin['Superadmin']['id'] = $user_id;
                    $this->Superadmin->save($superadmin);
                    break;
                case 'Manager':
                    $manager['Manager']['id'] = $user_id;
