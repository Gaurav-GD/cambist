...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<h3 class="page-title">
				<?php echo $upload_master_allocation; ?>&nbsp;&nbsp;&nbsp;<small><?php echo $upload_master_allocation; ?></small>
			</h3>
			<ul class="breadcrumb">
				<li>
					<?php
	...
	<div class="row-fluid">
		...
		<div class="row-fluid">
		    <div class="span8 offset2">
		        <?php 
		        	echo $this->Form->create('Teamleader',array("action" => "upload_master_allocation",'type' => 'file' ,"inputDefaults" => array("label"=>false,"div" => false,"class"=> "input-xlarge"))); 
		        ?>
		            <fieldset>
