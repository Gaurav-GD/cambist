...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">
            SuperAdmin <small>Users Details</small>
        </h3>
        <ul class="breadcrumb">
            <li>
            ...
            <div class="portlet-body">
                <div class="clearfix">
                    <div class="btn-group">
                        ...
                        <?php echo $this->Html->link("Add SuperAdmin <i class='icon-plus'></i>",array('action' => 'add'),array( 'id' => 'sample_editable_1_new','class' => 'btn green','escape' => false));?>
                    </div>
