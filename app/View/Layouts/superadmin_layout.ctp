		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active ">
					<?php echo $this->Html->link('<i class="icon-home"></i>  SuperAdmin' , array('controller' => 'superadmins' , 'action' => 'index') , array('class' => 'selected' , 'escape' => false)) ; ?>
				</li>
				<li class="">
					<a href="javascript:;">
					<i class=" "></i>
					...
					<ul class="sub-menu">
						<li >
							<?php echo $this->Html->link('View All',array('controller' => 'managers' , 'action' => 'index'));?>
						</li>
						<li >
							<?php echo $this->Html->link('Add New' , array('controller' => 'managers' , 'action' => 'add')) ; ?>
						</li>
					</ul>
				</li>
				<li class="">
